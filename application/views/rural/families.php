<!--BLOG AREA-->
<section class="event-page blog-area section-padding" id="blog">
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<div class="area-title text-center">
					<h2>Lists of Main Members</h2>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
				<div class="single-post">
					...
					<div class="post-details">
						<h3><a href="single-blog.html">Uncovers Ancient Ashkenaz.</a></h3>
						...
						<p class="post-meta">
							<a class="btn btn-warning" href="<?php echo base_url() ?>rural/member">View Details</a>
						</p>
					</div>
				</div>
			</div>
